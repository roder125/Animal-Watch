    ...
    if(animal.animalName == "" || animal.animalAge == null){
      ...
      //loader.present()
        //.then(()=>{
          ...
          animal.animalSpecies = this.species;
            ...
            this.animalList.pushImageUpload(this.imageArray[idx], uId, animal.animalName, idx, animal.entryDate)
              .then(data => {
                ...
                if(this.downloadUrls.length  == this.imageArray.length ){
                  ...
                  this.animalList.addAnimal(animal.animalName, animal.animalAge, animal.entryDate, this.downloadUrls, this.pathUrls , animal.description, animal.animalSpecies, animal.animalBreed, uId)
                    .then(()=>{
